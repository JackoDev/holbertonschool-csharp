...
/// <summary> Create public class called Player </summary>
class Player
{
    // public delegate void CalculateHealth(float amount);
    private string name;
    private float maxHp;
    private float hp;
    /// <summary> Constructor to assign parameters to properties </summary>
    ...
    /// <summary> Increases health points of player </summary>
    ...
    /// <summary> Prints health of player to console </summary>
    public void PrintHealth()
    {
        Console.WriteLine($"{name} has {hp} / {maxHp} health");
    }
    /// <summary> Calculates new value of Player's hp </summary>
    ...
    /// <summary> Outputs message with information about health points </summary>
    ...
    /// <summary> If HP is below a quarter of max hp then warns </summary>
    ...
    /// <summary> Adds HPValueWarning method to HPCheck event if below 1/4 hp </summary>
...
class CurrentHPArgs : EventArgs
{
    ...
    /// <summary> constructor that takes a float newHp and sets it as currentHp‘s value </summary>
